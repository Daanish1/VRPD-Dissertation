...
//Destroy-repair with no destruction range (DRR)
public class DestroyRepairRoute {
    ...
    public DestroyRepairRoute(Random random, SolutionInstance instance, ObjectiveFunction objectiveFunction) {
        this.random = random;
    ...
    //Apply DRR to all truck-drone pairs
    ...
    //Apply DRR to a single truck-drone pair
    private Solution destroyRepairSolution(Solution sol) {
        ...
        //While the time elapsed is less than the max run time allowed repeatedly perform DRR
